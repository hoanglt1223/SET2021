...
function LogInContent() {
  ...
  const [isRemeberMe, setRememberMe] = useState(false)
        ...
        return (
          <div id="login">
            ...
            <form id="login__form">
              ...
              <div className="remember_account">
                <input type='checkbox' className="remember_button" onClick={e => { setRememberMe(pre => pre ? false : true) }}></input>
