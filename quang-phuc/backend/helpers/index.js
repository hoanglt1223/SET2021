...
exports.handleError = function handleError(error, filePath = '', functionName = '') {
  ...
  switch (path[0]) {
    ...
    case 'users':
      ...
      switch (path[2]) {
        ...
        case 'update':
          return '/users/{username}/update'
        case 'delete':
          return '/users/{username}/delete'
      }
  }
}
